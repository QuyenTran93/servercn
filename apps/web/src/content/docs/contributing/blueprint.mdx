...
```json
{
  "$schema": "https://quyen93-servercn-web.vercel.app/schema/blueprint.registry.json",
  "slug": "my-blueprint",
  "runtimes": {
    "node": {
      "frameworks": {
...
- Points to the official Servercn [blueprint](https://quyen93-servercn-web.vercel.app/schema/blueprint.registry.json) schema.
