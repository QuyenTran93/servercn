...
```json
{
  "$schema": "https://servercn-vercel.vercel.app/schema/blueprint.registry.json",
  "slug": "my-blueprint",
  "runtimes": {
    "node": {
      "frameworks": {
...
- Points to the official Servercn [blueprint](https://servercn-vercel.vercel.app/schema/blueprint.registry.json) schema.
