...
```json
{
  "$schema": "https://quyen93-servercn-web.vercel.app/schema/schema.registry.json",
  "slug": "my-schema",
  "runtimes": {
    "node": {
      "frameworks": {
...
- Points to the official Servercn [schema](https://quyen93-servercn-web.vercel.app/schema/schema.registry.json) registry definition.
