...
```json
{
  "$schema": "https://servercn-vercel.vercel.app/schema/schema.registry.json",
  "slug": "my-schema",
  "runtimes": {
    "node": {
      "frameworks": {
...
- Points to the official Servercn [schema](https://servercn-vercel.vercel.app/schema/schema.registry.json) registry definition.
