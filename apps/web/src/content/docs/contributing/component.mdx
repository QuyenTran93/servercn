...
```json
{
  "$schema": "https://quyen93-servercn-web.vercel.app/schema/component.registry.json",
  "slug": "test-component",
  "runtimes": {
    "node": {
      "frameworks": {
...
- Points to the official Servercn [component](https://quyen93-servercn-web.vercel.app/schema/component.registry.json) schema.
...
{
  "name": "Servercn",
  "homepage": "https://quyen93-servercn-web.vercel.app",
  "author": "Akkal Dhami",
  "items": [
    ...
      {
