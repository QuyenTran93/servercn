...
```json
{
  "$schema": "https://servercn-vercel.vercel.app/schema/component.registry.json",
  "slug": "test-component",
  "runtimes": {
    "node": {
      "frameworks": {
...
- Points to the official Servercn [component](https://servercn-vercel.vercel.app/schema/component.registry.json) schema.
...
{
  "name": "Servercn",
  "homepage": "https://servercn-vercel.vercel.app",
  "author": "Akkal Dhami",
  "items": [
    ...
      {
