...
| File            | Purpose                            |
| --------------- | ---------------------------------- |
| `registry.json` | Component metadata & configuration |
| `templates/`    | Implementation templates per stack |
```
...
<PackageManagerTabs command="npx servercn add test-component" />
...
<PackageManagerTabs command="npx servercn add test-component --local" />
...
<Code>apps/web/src/content/docs/component/test-component.mdx</Code>
