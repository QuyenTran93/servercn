...
```json
{
  "$schema": "https://quyen93-servercn-web.vercel.app/schema/foundation.registry.json",
...
- Points to the official Servercn [foundation](https://quyen93-servercn-web.vercel.app/schema/foundation.registry.json) schema.
