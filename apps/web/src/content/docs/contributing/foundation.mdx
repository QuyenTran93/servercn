...
Some servercn foundations:
 - [Express Server Starter](/docs/foundations/express-server)
 - [Drizzle PostgreSQL Starter](/docs/foundations/drizzle-pg-starter)
 - [Drizzle MySQL Starter](/docs/foundations/drizzle-mysql-starter)
 - [Mongoose Starter](/docs/foundations/mongoose-starter)
  ...
  "runtimes": {
    "node": {
      "frameworks": {
        "express": {
          "templates": {
            "mvc": "express-server/mvc",
            "feature": "express-server/feature"
          },
          "dependencies": {
            "runtime": [
              "express",
...
<Code>apps/web/src/content/docs/foundations/foundation-slug.mdx</Code>
