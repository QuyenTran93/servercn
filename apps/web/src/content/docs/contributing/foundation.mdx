...
```json
{
  "$schema": "https://servercn-vercel.vercel.app/schema/foundation.registry.json",
...
- Points to the official Servercn [foundation](https://servercn-vercel.vercel.app/schema/foundation.registry.json) schema.
